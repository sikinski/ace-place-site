<template>
  <div class="home-page">
    <h1 class="start-heading">
      <span class="colorful-text">Лучшие акции</span> в городе
    </h1>
    <PriorityStocks />
    <CategoriesCarousel />
  </div>
...
<script>
import PriorityStocks from '@/components/PriorityStocks.vue';
import CategoriesCarousel from '@/components/CategoriesCarousel.vue';
export default { components: { PriorityStocks, CategoriesCarousel } };
</script>
